export const en = {
  ...
  auth: {
    ...
    loginDesc:
      "Connect your wallet and sign once to access balances, deposits, and trading.",
  ...
  profile: {
    ...
    applyListPerpsDesc:
      "Select your token, set the market opening time, and pay the listing fee. You must be the token owner.",
    ...
    perpsPairFactoryNotConfigured:
      "PerpsPairFactory is not configured. Set NEXT_PUBLIC_PERPS_PAIR_FACTORY.",
    ...
    applyListPerpsMarketExists: "This token is already listed for perps trading.",
    applyListOpeningPrice: "Opening price",
    applyListOpeningTime: "Opening time",
    applyListOpeningTimeHint: "Market opens at this local time (sent on-chain as Unix seconds).",
    applyListOpeningTimeRequired: "Select an opening time.",
    applyListListingFee: "Listing fee",
    applyListIncorrectFee: "Listing fee changed. Try again.",
    applyListFeeLoadFailed: "Could not read listing fee from the factory.",
    ...
    applyListInvalidOpeningTime: "Opening time must be in the future.",
  ...
  perps: {
    ...
    orderFailed: "Order failed",
    placingOrder: "Placing order…",
    exchangeNotConfigured: "PerpsExchange is not configured (NEXT_PUBLIC_PERPS_EXCHANGE_ADDRESS).",
    orderCancelled: "Order cancelled",
    cancel: "Cancel",
    cancelFailed: "Cancel failed",
    action: "Action",

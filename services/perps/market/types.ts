...
/** Mirrors `exchange.orbix.perps.market.store.dto.PairsUserReq`. */
export type MarketPairsUserReq = {
  pairIds: number[];
};

/** Mirrors `exchange.orbix.perps.market.store.dto.PairsRsp`. */
export type MarketPairsRsp = {
  pairs: MarketPairRsp[];
};

/** Mirrors `exchange.orbix.perps.market.store.dto.KlineCurrentDayReq`. */
export type KlineCurrentDayReq = {
  pairId: number;
};

/** Mirrors `exchange.orbix.perps.market.store.dto.KlineListReq`. */
...
/** Mirrors `exchange.orbix.perps.market.store.dto.KlineListRsp`. */
...
/** Mirrors `exchange.orbix.perps.market.store.dto.MarketKlineCurrentDayRsp`. */
...
/** Mirrors `exchange.orbix.perps.market.store.dto.TradeListRsp`. */
...
/** WS channel names (`perps-market-ws`). */

...
function PairRow({
  ...
  return (
    ...
    >
      ...
      />
      <Link
        href={`/perps/${pairPathFromCode(pair.code)}`}
        ...
        <div className="border-border/60 shrink-0 space-y-2 border-b px-3 py-2">
          <div className="relative">
            ...
            <Input
              ...
              placeholder={t("perps.searchPairs")}
            ...
            >
              {!isAuthenticated ? (
                ...
                <PairListItems
                  ...
                  emptyMessage={
                    query.trim() ? t("perps.noPairsFound") : t("perps.emptyFavorites")
                  }
            ...
            >
              {isAllLoading ? (
                ...
                <PairListItems
                  ...
                  activePair={activePair}
                  enginePriceDecimalMap={enginePriceDecimalMap}
                  emptyMessage={t("perps.noPairsFound")}
                />
              )}
            </TabsContent>
          </>

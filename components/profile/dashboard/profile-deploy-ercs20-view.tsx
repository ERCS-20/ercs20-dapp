...
export function ProfileDeployErcs20View() {
  const { t } = useI18n();
    ...
    return (
      <section className={profileDetailSectionClass}>
        ...
        <ProfileFormCardShell>
              ...
              {withToken ? (
                <div className="bg-muted/50 border-border/60 mt-6 space-y-2 rounded-2xl border p-3.5 sm:p-4">
                  ...
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-stretch">
                    <Input
                      ...
                      className="h-11 rounded-xl px-3 font-mono text-sm sm:flex-1"
                    />
                    <Button
                      type="button"
                      variant="secondary"
                      className="h-11 shrink-0 rounded-xl sm:px-5"
                      onClick={() => {
                        if (!withToken) return;
                  ...
                  <p className="text-muted-foreground text-xs tabular-nums">
                    {t("ercs20.registryIndex")}: {deployResult.index.toString()}
                  </p>
                </div>
              ) : (
              ...
              <p className="text-muted-foreground mt-4 break-all font-mono text-[11px] leading-relaxed">
  ...
  return (
    <section className={profileDetailSectionClass}>
      ...
      <ProfileFormCardShell>
            ...
            <div className="bg-muted/50 border-border/60 space-y-3.5 rounded-2xl border p-3.5 sm:p-4">
              <div className="space-y-1.5">
                <Label htmlFor="fc-name" className="text-muted-foreground text-xs sm:text-sm">
                  {t("ercs20.name")}
                </Label>
                <Input
                  id="fc-name"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="fc-symbol" className="text-muted-foreground text-xs sm:text-sm">
                  {t("ercs20.symbol")}
                </Label>
                <Input
                  id="fc-symbol"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="fc-supply" className="text-muted-foreground text-xs sm:text-sm">
                  {t("ercs20.totalSupply")}
                </Label>
                <Input
                  id="fc-supply"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="fc-seed" className="text-muted-foreground text-xs sm:text-sm">
                  {t("ercs20.seedQuote")}
                </Label>
                <Input
                  id="fc-seed"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="fc-price" className="text-muted-foreground text-xs sm:text-sm">
                  {t("ercs20.price")}
                </Label>
                <Input
                  id="fc-price"
                  ...
                  className="text-muted-foreground h-11 rounded-xl tabular-nums"
                  aria-live="polite"
                />
              </div>
            </div>

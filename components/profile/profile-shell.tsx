...
export type ProfileSection = "dashboard" | "spot-accounts" | "spot-deposits" | "spot-withdrawals";
...
export function ProfileShell({
  ...
  const spotSubItems: SpotSubItem[] = [
    { id: "spot-accounts", label: t("profile.spotAccountList"), icon: WalletIcon },
    { id: "spot-deposits", label: t("profile.spotDepositHistory"), icon: DownloadIcon },
    { id: "spot-withdrawals", label: t("profile.spotWithdrawHistory"), icon: UploadIcon },
  ];
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-4 lg:flex-row lg:gap-0">
        ...
        >
          ...
          <div className="mt-1 flex flex-col gap-0.5">
            ...
            {spotSubItems.map(({ id, label, icon: Icon }) => {
